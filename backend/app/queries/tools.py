...
def get_tool_usage(session: Session, days: int = 30):
    """Tool usage ranking."""
...
def get_tool_success_rates(session: Session, days: int = 30):
...
def get_tool_accept_reject(session: Session, days: int = 30):
...
def get_rejection_sources(session: Session, days: int = 30):
...
def get_tools_by_practice(session: Session, days: int = 30):
