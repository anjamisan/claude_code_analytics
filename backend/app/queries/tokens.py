...
def get_token_trends(session: Session, days: int = 30):
...
def get_tokens_by_practice(session: Session, days: int = 30):
...
def get_tokens_by_level(session: Session, days: int = 30):
...
def get_cache_efficiency(session: Session, days: int = 30):
...
def get_avg_cost_by_model(session: Session, days: int = 30):
